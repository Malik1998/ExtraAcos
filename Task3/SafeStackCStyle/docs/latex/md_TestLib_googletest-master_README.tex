...
\begin{DoxyItemize}
\item 1.\+8.\+x Release -\/ \href{https://github.com/google/googletest/releases/tag/release-1.8.1}{\tt the 1.\+8.\+x} is the last release that works with pre-\/\+C++11 compilers. The 1.\+8.\+x will not accept any requests for any new features and any bugfix requests will only be accepted if proven \char`\"{}critical\char`\"{}
...
\item Post 1.\+9.\+x googletest will follow \href{https://abseil.io/about/philosophy}{\tt Abseil Live at Head philosophy}
\end{DoxyItemize}
...
{\bfseries Google \hyperlink{classMock}{Mock}} is an extension to Google Test for writing and using C++ mock classes. See the separate Google Mock documentation.
...
\href{https://github.com/nholthaus/gtest-runner}{\tt G\+Test Runner} is a Qt5 based automated test-\/runner and Graphical User \hyperlink{classInterface}{Interface} with powerful features for Windows and Linux platforms.
