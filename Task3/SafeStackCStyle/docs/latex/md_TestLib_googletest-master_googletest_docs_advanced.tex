...
{\ttfamily Values\+In(container_)} and {\ttfamily Values\+In(begin,end)} &Yields values from a C-\/style array, an S\+T\+L-\/style container_, or an iterator range {\ttfamily \mbox{[}begin, end)}. \\\cline{1-2}
...
A pattern may contain `\textquotesingle{}$\ast$\textquotesingle{}{\ttfamily (matches any string) or}\textquotesingle{}?\textquotesingle{}` (matches any single character). For convenience, the filter

`\textquotesingle{}{\itshape -\/\+Negative\+Patterns\textquotesingle{}{\ttfamily can be also written as}\textquotesingle{}-\/\+Negative\+Patterns\textquotesingle{}`.}
...
{\itshape T\+IP\+: You can easily count_ the number of disabled tests you have using {\ttfamily gsearch} and/or {\ttfamily grep}. This number can be used as a metric for improving your test quality.}
...
{\itshape If your test program contains \href{#global-set-up-and-tear-down}{\tt global set-\/up/tear-\/down} code, it will be repeated in each iteration as well, as the flakiness may be in it. You can also specify the repeat count_ by setting the {\ttfamily G\+T\+E\+S\+T\+\_\+\+R\+E\+P\+E\+AT} environment variable.}
...
{\itshape ...~\newline
 \mbox{[}-\/-\/-\/-\/-\/-\/-\/---\mbox{]} 1 test from \hyperlink{classFooTest}{Foo\+Test}~\newline
