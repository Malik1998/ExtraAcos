...
If you plan to contribute a patch, you need to build Google Test, Google \hyperlink{classMock}{Mock}, and their own tests from a git checkout, which has further requirements\+:
